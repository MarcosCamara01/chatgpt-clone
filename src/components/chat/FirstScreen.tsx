...
export const FirstScreen = ({
  ...
  const columnH2 =
    "text-lg font-normal flex flex-row sm:flex-col items-center gap-3 m-auto";
  const columnUl = "flex flex-col m-auto w-full text-2xl	gap-3.5";
  const columnButton =
    "bg-[#3E3F4B] p-3 rounded-md w-full text-[15px] leading-5 transition duration-150 ease hover:bg-[#202123]";
  ...
  return (
    <div className="flex flex-col w-full leading-5">
      <div className="mx-auto	w-[90%] max-w-3xl flex flex-col text-[#ECECF1]">
        <h1 className="mx-auto mt-[75px] sm:mt-[20vh] sm:mb-16 font-bold text-4xl">
          ChatGPT
        </h1>
          ...
          <div className={column}>
            ...
            <ul className={columnUl}>
              ...
              <li>
                ...
                >
                  &quot;Got any creative ideas for a 10 year old&rsquo;s
                  birthday?&quot;
                </button>
              </li>
              <li>
