    ...
    return (
        <>
            ...
            >
                ...
                <div className='bg-white text-black text-xs min-w-[20px] rounded-full h-5 
                    w-5 flex items-center justify-center overflow-hidden'>
                    {session?.user?.image ?
                        <Image
            ...
            {open && (
                ...
                >
                    ...
                    <div className='py-1.5 px-3.5 text-[13px] transition duration-150 ease
                    ...
                    <UpdateKey userId={session.user._id} />
                </div>
            )}
        </>
    )
